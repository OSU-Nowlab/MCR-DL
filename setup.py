...
from mcr_dl.ops.op_builder import get_default_compute_capabilities, OpBuilder
from mcr_dl.ops.op_builder.all_ops import ALL_OPS
from mcr_dl.ops.op_builder.builder import installed_cuda_version
...
for op_name, builder in ALL_OPS.items():
    ...
    compatible_ops["MCR-DL_not_implemented"] = False
...
if sys.platform == "win32":
    ...
    create_dir_symlink('..\\..\\csrc', '.\\MCR-DL\\ops\\csrc')
    create_dir_symlink('..\\..\\op_builder', '.\\MCR-DL\\ops\\op_builder')
